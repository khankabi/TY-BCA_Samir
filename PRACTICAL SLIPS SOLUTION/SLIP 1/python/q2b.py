# write a pytho GUI program to take accept your birth date and output your age when a button is pressed.
from tkinter import *
...
exitButton = Button(text="Exit", command=sys.exit).grid(row=7, column=1, pady=10)
root.mainloop()